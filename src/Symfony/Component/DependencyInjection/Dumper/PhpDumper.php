...
EOF;
    ...
    private function doExport($value)
    {
        ...
        if ("'" === $export[0] && $export !== $resolvedExport = $this->container->resolveSecretPlaceholders($this->container->resolveEnvPlaceholders($export, "'.\$this->getEnv('%s').'"), "'.\$this->getSecret('%s').'")) {
