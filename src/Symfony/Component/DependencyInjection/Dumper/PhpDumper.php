...
class PhpDumper extends Dumper
{
    ...
    public function dump(array $options = array())
    {
        ...
        foreach ($this->classReflectors as $r) {
    ...
    {
        if (!isset($this->classReflectors[$class = $definition->getClass()])) {
            $this->classReflectors[$class] = new \ReflectionClass($class);
        }
...
EOF;
    ...
    private function addNewInstance(Definition $definition, $return, $instantiation, $id)
    {
        ...
        if ($definition->getOverriddenGetters()) {
            ...
            $constructor = $this->classReflectors[$definition->getClass()]->getConstructor();
...
EOF;
    ...
    private function dumpValue($value, $interpolate = true)
    {
        if (is_array($value)) {
            ...
            $r = $this->classReflectors[$class]->getMethod($method);
            if (!$r->isPublic()) {
